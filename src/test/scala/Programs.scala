...
object Programs{
  ...
  val erosion = Array(
    ...
    "b100001_00101_00000_0000000000111001".U(32.W), // 07. JEQ R5 R0 57       Jump to END if R5 = 0
    ...
    "b100001_01000_00000_0000000000110111".U(32.W), // 11. JEQ R8 R0 55       Jump to x++ if R8 = 0
    ...
    "b100001_00011_00000_0000000000010010".U(32.W), // 15. JEQ R3 R0 18       Jump to line 17 if x=0
    "b100000_00000_00000_0000000000010100".U(32.W), // 16. JR 20              Jump to line 19 if x!=0
    ...
    "b100001_00110_00000_0000000000010100".U(32.W), // 19. JEQ R6 R0 20       Jump to line 21 if y=0
    "b100000_00000_00000_0000000000010111".U(32.W), // 20. JR 23              Jump to line 24 if y!=0
    ...
    "b100001_01100_00000_0000000000100100".U(32.W), // 33. JEQ R12 R0 35      Jump to line 35 if memory[R11]=0
    ...
    "b100001_01011_00000_0000000000100111".U(32.W), // 37. JEQ R11 R0 39      Jump to line 39 if R11=0
    ...
    "b100001_01011_00000_0000000000101010".U(32.W), // 40. JEQ R11 R0 42      Jump to line 42 if R11=0
    ...
    "b100000_00000_00000_0000000000001010".U(32.W), // 56. JR 10              Jump to line 11 for a new y-loop

    "b000011_00011_00011_0000000000000001".U(32.W), // 57. ADDI R3 R3 1       x++

    "b100000_00000_00000_0000000000000110".U(32.W), // 58. JR 6               Jump to line 7 for a new x-loop
